...
vim.keymap.set('n', '<leader>bn', ':bn<cr>', { desc = 'Close current buffer' })
vim.keymap.set('n', '<leader>bp', ':bp<cr>', { desc = 'Close current buffer' })
...
vim.keymap.set('n', '<M-w>', '<C-w><C-q>')
vim.keymap.set('n', '<M-n>', '<C-w><C-n>')
vim.keymap.set('n', '<M-x>', '<C-w><C-o>')
vim.keymap.set('n', '<M-m>', ':vnew<CR>')
